...
('1098765432', '20261001', 'Juan Perez',     'Juan',  'Perez',    '$2a$10$TCpV633Sg7xBIMP/VpL80uQw9YHjSPvk5iFmk6aFs.yxQwVq5eSBq', 1, 40,
...
('1098765435', '20261005', 'Laura Gomez',    'Laura', 'Gomez',    '$2a$10$TCpV633Sg7xBIMP/VpL80uQw9YHjSPvk5iFmk6aFs.yxQwVq5eSBq', 1, 56,
    (SELECT id FROM programa_academico WHERE nombre = 'Maestría en Gerencia de Empresas')),
-- Estudiante demo: solicitud pendiente de pago
('1098765436', '20261006', 'Pedro Martinez', 'Pedro', 'Martinez', '$2a$10$TCpV633Sg7xBIMP/VpL80uQw9YHjSPvk5iFmk6aFs.yxQwVq5eSBq', 1, 56,
    (SELECT id FROM programa_academico WHERE nombre = 'Maestría en Gerencia de Empresas')),
-- Estudiante demo: solicitud rechazada
('1098765437', '20261007', 'Carlos Rueda',   'Carlos','Rueda',    '$2a$10$TCpV633Sg7xBIMP/VpL80uQw9YHjSPvk5iFmk6aFs.yxQwVq5eSBq', 1, 56,
    (SELECT id FROM programa_academico WHERE nombre = 'Maestría en Gerencia de Empresas')),
-- Director del mismo programa
('1098765433', '20261002', 'Maria Director', 'Maria', 'Director', '$2a$10$TCpV633Sg7xBIMP/VpL80uQw9YHjSPvk5iFmk6aFs.yxQwVq5eSBq', 2, NULL,
    (SELECT id FROM programa_academico WHERE nombre = 'Maestría en Gerencia de Empresas')),
('1098765434', '20261003', 'Admin User',     'Admin', 'User',     '$2a$10$TCpV633Sg7xBIMP/VpL80uQw9YHjSPvk5iFmk6aFs.yxQwVq5eSBq', 3, 30,
    (SELECT id FROM programa_academico WHERE nombre = 'Especialización en Estructuras'))
ON CONFLICT (cedula) DO NOTHING;

-- Estudiantes adicionales para TIC
INSERT INTO usuario (cedula, codigo, nombre_completo, primer_nombre, primer_apellido, contrasena, rol_id, creditos_aprobados, programa_id) VALUES
('1098765440', '20261010', 'Ana Torres', 'Ana', 'Torres', '$2a$10$TCpV633Sg7xBIMP/VpL80uQw9YHjSPvk5iFmk6aFs.yxQwVq5eSBq', 1, 56,
...
('2000000001', 'DIR001', 'Carlos Director Grado', 'Carlos', 'Director', '$2a$10$TCpV633Sg7xBIMP/VpL80uQw9YHjSPvk5iFmk6aFs.yxQwVq5eSBq', 'director.posgrado@test.com', 2,
    (SELECT id FROM programa_academico WHERE nombre = 'Maestría en Gerencia de Empresas'))
ON CONFLICT (cedula) DO NOTHING;

INSERT INTO usuario (cedula, codigo, nombre_completo, primer_nombre, primer_apellido, contrasena, email, rol_id, programa_id) VALUES
('3000000001', 'DEP001', 'Biblioteca Central',     'Biblioteca', 'Central',    '$2a$10$TCpV633Sg7xBIMP/VpL80uQw9YHjSPvk5iFmk6aFs.yxQwVq5eSBq', 'kevarias.2195@gmail.com', 5, NULL),
('3000000002', 'DEP002', 'División Financiera',    'División',   'Financiera', '$2a$10$TCpV633Sg7xBIMP/VpL80uQw9YHjSPvk5iFmk6aFs.yxQwVq5eSBq', 'financiera@test.com',     5, NULL),
('3000000003', 'DEP003', 'Admisiones y Registro',  'Admisiones', 'Registro',   '$2a$10$TCpV633Sg7xBIMP/VpL80uQw9YHjSPvk5iFmk6aFs.yxQwVq5eSBq', 'admisiones@test.com',     5, NULL)
ON CONFLICT (cedula) DO NOTHING;
...
('2000000010', 'EST010', 'Andrea Prueba Grado', 'Andrea', 'Prueba', '$2a$10$TCpV633Sg7xBIMP/VpL80uQw9YHjSPvk5iFmk6aFs.yxQwVq5eSBq', 'andrea.grado@test.com', 1, 56,
    (SELECT id FROM programa_academico WHERE nombre = 'Maestría en Gerencia de Empresas'))
ON CONFLICT (cedula) DO NOTHING;

INSERT INTO usuario (cedula, codigo, nombre_completo, primer_nombre, primer_apellido, contrasena, email, rol_id, creditos_aprobados, programa_id) VALUES
('2000000011', 'EST011', 'Kevin Estudiante', 'Kevin', 'Estudiante', '$2a$10$TCpV633Sg7xBIMP/VpL80uQw9YHjSPvk5iFmk6aFs.yxQwVq5eSBq', 'kevin.est@test.com', 1, 56,
    (SELECT id FROM programa_academico WHERE nombre = 'Maestría en Gerencia de Empresas'))
ON CONFLICT (cedula) DO NOTHING;

INSERT INTO usuario (cedula, codigo, nombre_completo, primer_nombre, primer_apellido, contrasena, email, rol_id, programa_id) VALUES
('1098765434', '20261003', 'Coordinador Posgrados', 'Coordinador', 'Posgrados', '$2a$10$TCpV633Sg7xBIMP/VpL80uQw9YHjSPvk5iFmk6aFs.yxQwVq5eSBq', 'posgrados@test.com', 4,
    (SELECT id FROM programa_academico WHERE nombre = 'Maestría en Gerencia de Empresas'))
